...
If you tried to run `gh pr checkout 32` and got an error, **PR #32 doesn't exist** in this repository. 

**Quick Help:**
```bash
./pr32-help.sh  # Run this script for immediate assistance
```

**What to do instead:**
- Check available PRs: `gh pr list`
- See [GitHub CLI Usage Guide](./GITHUB_CLI_GUIDE.md) for detailed instructions
- Use an existing PR number or create a new one if needed
